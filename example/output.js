...
//  (let [(order-id (ref/new 1755)) (restaurant-name (ref/new "Venezia")) (customer-name (ref/new "Jan Kowalski")) (customer-phone (ref/new "123")) (confirmed (ref/new false)) (details-row (fn ((label String) (body (-> [] Unit))) (el "tr" no-props (fn () (do (el "th" no-props (fn () (text (dynamic/pure label)))) (el "td" no-props body)))))) (text-input (fn ((props (Array Prop)) (ref (Dynamic String))) (el "input" (array/concat props [(on-input (fn ((value String)) (ref/write ref (dynamic/pure value)))) (attr "value" ref)]) (fn () (do)))))] (render-in-body (fn () (do (el "table" no-props (fn () (do (details-row "Order id" (fn () (text (dynamic/bind order-id (fn ((_$0 Int)) (dynamic/pure (int->string _$0))))))) (details-row "Restaurant" (fn () (text restaurant-name))) (details-row "Customer" (fn () (text (dynamic/bind (dynamic/bind customer-name (fn ((_$1 String)) (dynamic/pure (concat _$1 ", ")))) (fn ((_$2 String)) (dynamic/bind customer-phone (fn ((_$3 String)) (dynamic/pure (concat _$2 _$3))))))))) (details-row "Status" (fn () (text (dynamic/pure "Confirmed"))))))) (el "div" no-props (fn () (do (el "label" no-props (fn () (text (dynamic/pure "Customer name: ")))) (text-input no-props customer-name)))) (el "div" no-props (fn () (el "button" [(on-click (fn () (ref/write customer-phone (dynamic/bind customer-phone (fn ((_$4 String)) (dynamic/pure (concat _$4 "7")))))))] (fn () (text (dynamic/pure "Change phone")))))) (el "div" no-props (fn () (do (el "label" no-props (fn () (text (dynamic/pure "Restaurant: ")))) (text-input no-props restaurant-name)))))))))
var order$minusexample = ((()=>{var order$minusid = ref$slashnew(1755);var restaurant$minusname = ref$slashnew("Venezia");var customer$minusname = ref$slashnew("Jan Kowalski");var customer$minusphone = ref$slashnew("123");var confirmed = ref$slashnew(false);var details$minusrow = ((label,body) => el("tr",no$minusprops,(() => ((()=>{el("th",no$minusprops,(() => text(dynamic$slashpure(label))));return el("td",no$minusprops,body);})()))));var text$minusinput = ((props,ref) => el("input",array$slashconcat(props,[on$minusinput(((value) => ref$slashwrite(ref,dynamic$slashpure(value)))),attr("value",ref)]),(() => ((()=>{})()))));return render$minusin$minusbody((() => ((()=>{el("table",no$minusprops,(() => ((()=>{details$minusrow("Order id",(() => text(dynamic$slashbind(order$minusid,((_$$0) => dynamic$slashpure(int$minus$gtstring(_$$0)))))));details$minusrow("Restaurant",(() => text(restaurant$minusname)));details$minusrow("Customer",(() => text(dynamic$slashbind(dynamic$slashbind(customer$minusname,((_$$1) => dynamic$slashpure(concat(_$$1,", ")))),((_$$2) => dynamic$slashbind(customer$minusphone,((_$$3) => dynamic$slashpure(concat(_$$2,_$$3)))))))));return details$minusrow("Status",(() => text(dynamic$slashpure("Confirmed"))));})())));el("div",no$minusprops,(() => ((()=>{el("label",no$minusprops,(() => text(dynamic$slashpure("Customer name: "))));return text$minusinput(no$minusprops,customer$minusname);})())));el("div",no$minusprops,(() => el("button",[on$minusclick((() => ref$slashwrite(customer$minusphone,dynamic$slashbind(customer$minusphone,((_$$4) => dynamic$slashpure(concat(_$$4,"7")))))))],(() => text(dynamic$slashpure("Change phone"))))));return el("div",no$minusprops,(() => ((()=>{el("label",no$minusprops,(() => text(dynamic$slashpure("Restaurant: "))));return text$minusinput(no$minusprops,restaurant$minusname);})())));})())));})());
